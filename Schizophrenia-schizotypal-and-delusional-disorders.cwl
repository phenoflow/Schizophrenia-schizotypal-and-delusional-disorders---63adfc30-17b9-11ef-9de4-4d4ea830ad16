...
steps:
  ...
  schizophrenia-schizotypal-and-delusional-disorders-condition---primary:
    run: schizophrenia-schizotypal-and-delusional-disorders-condition---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  schizophrenia-schizotypal-and-delusional-disorders-unspecified---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: schizophrenia-schizotypal-and-delusional-disorders-condition---primary/output
